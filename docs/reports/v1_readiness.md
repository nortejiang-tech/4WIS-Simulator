...
| `browser_smoke` | PASS | yes | `frontend/tests/e2e/workflow-smoke.spec.ts`<br>`frontend/package.json` | workflow-smoke.spec.ts contains 54 browser smoke cases and package.json exposes e2e:prod. |
...
| `release_delivery` | PASS | yes | `scripts/check_release_assets.py`<br>`docs/user_manual.html`<br>`docs/manual_figs`<br>`dist_portable` | 39 delivery material checks pass. |
