...
- `release_delivery`: docs/user_manual.html: missing marker(s): v0.102.0
...
| `release_delivery` | FAIL | yes | `scripts/check_release_assets.py`<br>`docs/user_manual.html`<br>`docs/manual_figs`<br>`dist_portable` | docs/user_manual.html: missing marker(s): v0.102.0 |
