...
| `browser_smoke` | PASS | yes | `frontend/tests/e2e/workflow-smoke.spec.ts`<br>`frontend/package.json` | workflow-smoke.spec.ts contains 50 browser smoke cases and package.json exposes e2e:prod. |
